...
#	Introducción jdgjhdgfkds  R y RStudio 
...
#	Un recorrido por el universo de Tidyverse
...
Empleando el paquete readr se hará un recorrido por las distintas formas de abrir archivos de distintos formatos, principalmente: archivos .txt, .xlsx, .sav, .dta, .sav entre otros. Además se discute las maneras en las que se introducen argumentos para obtener mejores resultados en la apertura de estos archivos.
