...
subtitle: "Clase 3: Estructuras de control"
author: "Alex Bajaña"
institute: "infoRmal"
...
background-image: url(aleatorios.jpg)
...
- **`rnorm`:** genera variables aleatorias que siguen una distribución normal con una media y desviación estándar dadas.
...
- **`rpois`:** genera variables aleatorias que siguen una distribución de Poisson dado un determinado parámetro.
...
- Se producen 100 cervezas al día. Existe un 10% de probabilidad de encontrar un error ¿Cuántas se deben arreglar al día?
...
background-image: url(repito.jpg)
background-size: cover
...
Existen alternativas para los bucles que optimizan: 

- Uso de memoria
- Tiempos de procesamiento
- TIempo codificando
  
Son especialmente necesarios en el uso Cadenas de Markov o simulaciones Monte Carlo que dependen del lanzamiento $[i-1]$  de la iteración $i$ 

## ¿Procesamiento en paralelo osecuencial?
